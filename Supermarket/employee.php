...
<body>
	...
	<div class="input-group">
		...
		<div class="column middle">
			...
			<span style="padding-left:45px"><b>Salary :</b> 
		...
		<div class="column right">
				...
				<button type="submit" name="empinsert" class="btn">INSERT</button><br/>
				...
				<br><a href="displayemp.php">employee details</a>
